...
public class HumanPaddle extends Paddle{
   ...
   public int reactToKey(int keyPressed){
      ...
      else if (keyPressed == KEY_MOVE_DOWN){ // this was one of the bugs because you 
         return Paddle.MOVE_DOWN; // only returned down if key up wasnt pressed so Java assumes 
      }              // that a key other than up arrow is down 
      else{
         return 0; 
      }
   }
   ...
   }                    // but if you just do this.volleys++ it fixes it
