...
public class TrigHelpers{
   ...
   //Returns the X coordinate of the next wall bounce, given the ball's current location and trajectory
   //this does not account for the window dimensions, thus if the ball would not hit a wall before reaching
